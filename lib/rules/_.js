...
exports.Rules = {
    ...
    IsPhone: IsPhone_1.IsPhone, IsPhoneNational: IsPhoneNational_1.IsPhoneNational, IsRequired: IsRequired_1.IsRequired, IsRequiredWith: IsRequiredWith_1.IsRequiredWith, IsUsername: IsUsername_1.IsUsername,
    Match: Match_1.Match, Max: Max_1.Max, MaxLength: MaxLength_1.MaxLength, Min: Min_1.Min, MinLength: MinLength_1.MinLength, NotMatch: NotMatch_1.NotMatch, Sometimes: Sometimes_1.Sometimes
};
